...
engine.apply_change(engine.propose_architecture_change(
    "fix governance", "modify_dependencies", "governance", ["metaintel"], 0.1).proposal_id)
...
prop1 = engine.propose_architecture_change(
    "add circular_mod", "add_module", "circular_mod",
    new_dependencies=["execution"], risk_score=0.3,
)

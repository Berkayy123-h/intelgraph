...
HIGH_IMPACT_KEYWORDS: set[str] = {
    "ceo", "cto", "cfo", "coo", "chief", "president", "chairman",
    "founder", "director", "executive", "vp", "vice president",
    "governor", "senator", "congressman", "congresswoman", "minister",
    "ambassador", "judge", "general", "admiral", "secretary",
    "politician", "candidate", "mayor", "senator",
}

HIGH_IMPACT_DOMAINS: set[str] = {
    "finance", "banking", "health", "healthcare", "medical",
    "government", "gov", "military", "defense", "intelligence",
    "pharma", "energy", "nuclear", "biotech",
}
...
class HighImpactHandler:
    ...
    @staticmethod
    def requires_confirmed(entity_type: str, name: str = "", title: str = "", industry: str = "") -> bool:
        return HighImpactHandler.is_high_impact(entity_type, name, title, industry)

    @staticmethod
    def verification_requirement(verification_state: VerificationState, is_high_impact: bool) -> str:

...
from intelgraph.core.metaintel.self_improvement import OptimizationProposal, SelfImprovementController
from intelgraph.core.metaintel.architecture import ArchitectureEvolutionEngine, ArchitectureModule, ArchitectureProposal
